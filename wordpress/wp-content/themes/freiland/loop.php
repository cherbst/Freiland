...
<?php if ( ! have_posts() ) : ?>
	...
	<?php global $wp_query;
		if ( $wp_query->query_vars['category_name'] == 'images'){ ?>
		<h1 class="entry-title">Noch keine Galerieen<br /> vorhanden</h1>
		<div class="entry-content">
			<p><?php _e( 'An dieser Stelle werden in Kürze Bildergalerien hinzugefügt.', 'twentyten' ); ?></p>
		</div><!-- .entry-content -->
		<?php }else{ ?>
